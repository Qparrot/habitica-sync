...
import { getStats, scoreTask, makeCronReq, costReward, scoreChecklistItem, deleteTask } from "./habiticaAPI"
    ...
    render() {
        ...
        if (this.state.error)
            ...
            return (<div className="plugin-root">
                ...
                <Taskview data={this.state.tasks} handleChangeTodos={this.handleChangeTodos} settings = {this.props.plugin.settings} handleChangeDailys={this.handleChangeDailys} handleChangeHabits={this.handleChangeHabits} handleChangeRewards={this.handleChangeRewards} handleChangeChecklistItem={this.handleChangeChecklistItem} handleDeleteTask={this.handleDeleteTask}/>
